...
ICALL(ENV_UNITY1, "get_EmbeddingHostName", mono_unity_get_embeddinghostname)
...
ICALL(ENV_UNITY2, "get_SocketSecurityEnabled", mono_unity_socket_security_enabled_get)
...
ICALL_TYPE(UNITYLOGWRITER_1, "System.IO.UnityLogWriter", UNITYLOGWRITER_1)
ICALL(UNITYLOGWRITER_1, "WriteStringToUnityLog(string)", mono_unity_write_to_unity_log)
...
ICALL(SOCK_6, "Connect_internal_real(intptr,System.Net.SocketAddress,int&)", ves_icall_System_Net_Sockets_Socket_Connect_internal)
...
ICALL(SOCK_16, "SendTo_internal_real(intptr,byte[],int,int,System.Net.Sockets.SocketFlags,System.Net.SocketAddress,int&)", ves_icall_System_Net_Sockets_Socket_SendTo_internal)
...
ICALL(SOCK_22, "socket_pool_queue_internal", icall_append_io_job)
